...
public class PageUIPersonalDetail {
    ...
    public static final By COMPANY_DROPDOWN_SELECTION = By.xpath("//div[@placeholder='Select any of the following']");
    public static final By COMPANY_DROPDOWN_SELECTION_LIST = By.xpath("//div[@class='q-item__label']");
    public static final By OPTION_SELECTION = By.xpath("//div[@placeholder='Select applicable options']");
    ...
    public static final By DATE_OF_BIRTH_TEXT_BOX = By.xpath("//input[@placeholder='Set your date of birth']");
    public static final By NATIONALITY_DROPDOWN = By.xpath("//div[@placeholder='Type to Search or Select Nationality']");
    public static final By NATIONALITY_DROPDOWN_LIST = By.xpath("//div[@class='q-item__label']");
    public static final By GENDER_DROPDOWN = By.xpath("//input[@placeholder='Set your gender']");
